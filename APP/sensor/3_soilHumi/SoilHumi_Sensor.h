#ifndef _SOILHUMI_SENSOR_H
#define _SOILHUMI_SENSOR_H
...
#define MAX_SENSOR_NUM                    5 //定义传感器最大接入数量
#define SAMPLE_COUNT                      10//单通道采样循环数
#define SAMPLE_DATA_NUM                   SAMPLE_COUNT * MAX_SENSOR_NUM   //5个通道，每个通道一分钟有30个数
#define STANDARD_DEV_NUM                  5//标准差数量
...
typedef struct{
  ...
  qc_ctrl_t qualityCtrl[MAX_SENSOR_NUM];
