...
unsigned char sample_qc[MAX_ELEMENT_NUM][4];		//第二个值 和采样值有关
unsigned char sample_qc_history[MAX_ELEMENT_NUM][4];
...
*函数引用：CorrectionFactor_humi(&temp_temp_value);
*/
unsigned char   CorrectionFactor_humi(float temp,unsigned char err,sensors_data_t *sensors_tempdata)
{//分段线性
  if(err == 0)//采集温度正确
  {
    if((int)temp > 30)//高温系数
    {
      if((sensors_tempdata->sensor[0].secdata.data>=0)&&(sensors_tempdata->sensor[0].secdata.data<bcm_info.sensor.crHum[2].HUMI_DATA_35))
      {
        sensors_tempdata->sensor[0].secdata.data = \
          ((35-12)*(sensors_tempdata->sensor[0].secdata.data-bcm_info.sensor.crHum[2].HUMI_DATA_12)/(bcm_info.sensor.crHum[2].HUMI_DATA_35-bcm_info.sensor.crHum[2].HUMI_DATA_12))+12;
      }
      else if((sensors_tempdata->sensor[0].secdata.data>=bcm_info.sensor.crHum[2].HUMI_DATA_35)&&(sensors_tempdata->sensor[0].secdata.data<bcm_info.sensor.crHum[2].HUMI_DATA_55))
      {
        sensors_tempdata->sensor[0].secdata.data = \
          ((55-35)*(sensors_tempdata->sensor[0].secdata.data-bcm_info.sensor.crHum[2].HUMI_DATA_35)/(bcm_info.sensor.crHum[2].HUMI_DATA_55-bcm_info.sensor.crHum[2].HUMI_DATA_35))+35;
      }

      else if((sensors_tempdata->sensor[0].secdata.data>=bcm_info.sensor.crHum[2].HUMI_DATA_55)&&(sensors_tempdata->sensor[0].secdata.data<bcm_info.sensor.crHum[2].HUMI_DATA_75))
      {
        sensors_tempdata->sensor[0].secdata.data = \
          ((75-55)*(sensors_tempdata->sensor[0].secdata.data-bcm_info.sensor.crHum[2].HUMI_DATA_55)/(bcm_info.sensor.crHum[2].HUMI_DATA_75-bcm_info.sensor.crHum[2].HUMI_DATA_55))+55;
      }

      else if((sensors_tempdata->sensor[0].secdata.data>=bcm_info.sensor.crHum[2].HUMI_DATA_75)&&(sensors_tempdata->sensor[0].secdata.data<=100))
      {
        sensors_tempdata->sensor[0].secdata.data = \
          ((90-75)*(sensors_tempdata->sensor[0].secdata.data-bcm_info.sensor.crHum[2].HUMI_DATA_75)/(bcm_info.sensor.crHum[2].HUMI_DATA_90-bcm_info.sensor.crHum[2].HUMI_DATA_75))+75;
      }
    }
    else if(((int)temp > -10)&&((int)temp <= 30))//常温系数
    {
      if((sensors_tempdata->sensor[0].secdata.data>=0)&&(sensors_tempdata->sensor[0].secdata.data<bcm_info.sensor.crHum[1].HUMI_DATA_35))
      {
        sensors_tempdata->sensor[0].secdata.data = \
          ((35-12)*(sensors_tempdata->sensor[0].secdata.data-bcm_info.sensor.crHum[1].HUMI_DATA_12)/(bcm_info.sensor.crHum[1].HUMI_DATA_35-bcm_info.sensor.crHum[1].HUMI_DATA_12))+12;
      }
      else if((sensors_tempdata->sensor[0].secdata.data>=bcm_info.sensor.crHum[1].HUMI_DATA_35)&&(sensors_tempdata->sensor[0].secdata.data<bcm_info.sensor.crHum[1].HUMI_DATA_55))
      {
        sensors_tempdata->sensor[0].secdata.data = \
          ((55-35)*(sensors_tempdata->sensor[0].secdata.data-bcm_info.sensor.crHum[1].HUMI_DATA_35)/(bcm_info.sensor.crHum[1].HUMI_DATA_55-bcm_info.sensor.crHum[1].HUMI_DATA_35))+35;
      }

      else if((sensors_tempdata->sensor[0].secdata.data>=bcm_info.sensor.crHum[1].HUMI_DATA_55)&&(sensors_tempdata->sensor[0].secdata.data<bcm_info.sensor.crHum[1].HUMI_DATA_75))
      {
        sensors_tempdata->sensor[0].secdata.data = \
          ((75-55)*(sensors_tempdata->sensor[0].secdata.data-bcm_info.sensor.crHum[1].HUMI_DATA_55)/(bcm_info.sensor.crHum[1].HUMI_DATA_75-bcm_info.sensor.crHum[1].HUMI_DATA_55))+55;
      }

      else if((sensors_tempdata->sensor[0].secdata.data>=bcm_info.sensor.crHum[1].HUMI_DATA_75)&&(sensors_tempdata->sensor[0].secdata.data<=100))
      {
        sensors_tempdata->sensor[0].secdata.data = \
          ((90-75)*(sensors_tempdata->sensor[0].secdata.data-bcm_info.sensor.crHum[1].HUMI_DATA_75)/(bcm_info.sensor.crHum[1].HUMI_DATA_90-bcm_info.sensor.crHum[1].HUMI_DATA_75))+75;
      }
    }
    else if(((int)temp > -50)&&((int)temp <= -10))//负温度系数
    {
      if((sensors_tempdata->sensor[0].secdata.data>=0)&&(sensors_tempdata->sensor[0].secdata.data<bcm_info.sensor.crHum[0].HUMI_DATA_35))
      {
        sensors_tempdata->sensor[0].secdata.data = \
          ((35-12)*(sensors_tempdata->sensor[0].secdata.data-bcm_info.sensor.crHum[0].HUMI_DATA_12)/(bcm_info.sensor.crHum[0].HUMI_DATA_35-bcm_info.sensor.crHum[0].HUMI_DATA_12))+12;
      }
      else if((sensors_tempdata->sensor[0].secdata.data>=bcm_info.sensor.crHum[0].HUMI_DATA_35)&&(sensors_tempdata->sensor[0].secdata.data<bcm_info.sensor.crHum[0].HUMI_DATA_55))
      {
        sensors_tempdata->sensor[0].secdata.data = \
          ((55-35)*(sensors_tempdata->sensor[0].secdata.data-bcm_info.sensor.crHum[0].HUMI_DATA_35)/(bcm_info.sensor.crHum[0].HUMI_DATA_55-bcm_info.sensor.crHum[0].HUMI_DATA_35))+35;
      }

      else if((sensors_tempdata->sensor[0].secdata.data>=bcm_info.sensor.crHum[0].HUMI_DATA_55)&&(sensors_tempdata->sensor[0].secdata.data<100))
      {
        sensors_tempdata->sensor[0].secdata.data = \
          ((75-55)*(sensors_tempdata->sensor[0].secdata.data-bcm_info.sensor.crHum[0].HUMI_DATA_55)/(bcm_info.sensor.crHum[0].HUMI_DATA_75-bcm_info.sensor.crHum[0].HUMI_DATA_55))+55;
      }

      //      else if((sensors_tempdata->sensor[0].secdata.data>=bcm_info.sensor.crHum[0].HUMI_DATA_55)&&(sensors_tempdata->sensor[0].secdata.data<bcm_info.sensor.crHum[0].HUMI_DATA_75))
      //      {
      //        sensors_tempdata->sensor[0].secdata.data = \
        //          ((75-55)*(sensors_tempdata->sensor[0].secdata.data-bcm_info.sensor.crHum[0].HUMI_DATA_55)/(bcm_info.sensor.crHum[0].HUMI_DATA_75-bcm_info.sensor.crHum[0].HUMI_DATA_55))+55;
        //      }
        //
        //      else if((sensors_tempdata->sensor[0].secdata.data>=bcm_info.sensor.crHum[0].HUMI_DATA_75)&&(sensors_tempdata->sensor[0].secdata.data<=100))
        //      {
        //        sensors_tempdata->sensor[0].secdata.data = \
          //          ((90-75)*(sensors_tempdata->sensor[0].secdata.data-bcm_info.sensor.crHum[0].HUMI_DATA_75)/(bcm_info.sensor.crHum[0].HUMI_DATA_90-bcm_info.sensor.crHum[0].HUMI_DATA_75))+75;
          //      }
    }
    return 1;
  }

  else  if(err == 1)//采集温度错误
  {
    return 1;
  }
  return 0;
...
{
    unsigned char i = 0;
    float temp_value[3] = {0}, Temperature = 0;
    unsigned char temp_sample_event = 0;
    //float logew = 0, him = 0, temp = 0;

  if(Num_sample<SAMPLE_COUNT)
  {
    temp_sample_event= AirH_engine(temp_value);//读计数清零计数
    ...
    {//采集完成
      ...
      //him=temp_value[0];    //计算露点
      //temp=temp_value[2];
      //logew = (0.66077 + 7.5* temp/(273.3 + temp) + log10f(him) - 2);
      //temp_value[1] = (0.66077 - logew)*237.3/(logew - 8.16077);

      Temperature = temp_value[2];
      for(i = 0;i<MAX_ELEMENT_NUM;i++)  //提取露点、湿度做校准
      {
        //校正参数  CR
    ...
    /*if((Temperature>-50)&&(Temperature<100))
      {
          CorrectionFactor_humi(Temperature,0,sensors_tempdata);
      }
      else
      {
          CorrectionFactor_humi(Temperature,1,sensors_tempdata);
      }*/
      ...
      //------------------------露点秒级数据存储-----------------------------------
      sensors_tempdata->sensor[1].secdata.qc = sensors_tempdata->sensor[0].secdata.qc;
      if(sensors_tempdata->sensor[1].secdata.qc == QC_OK)
      {
        sensors_tempdata->sensor[1].secdata_counter++;//分钟数据累加
        sensors_tempdata->sensor[1].secdata_add.data += sensors_tempdata->sensor[1].secdata.data;
      }
	 //---------------------------------------------------------------------------	
      for(i = 0;i<MAX_ELEMENT_NUM;i++)
      {
...
unsigned char Element_MinSample(sensors_data_t *sensors_tempdata)
{
    ...
    //露点的QC 等于湿度
    sensors_tempdata->sensor[1].mindata.qc = sensors_tempdata->sensor[0].mindata.qc;
    if(sensors_tempdata->sensor[1].mindata.qc == QC_ERROR)
    {
        //sensors_tempdata->sensor[1].mindata.data=INVALID_DATA;
    }
...
//---------------------------head  finish--------------------------
    //---------------------------data  start---------------------------
    //------------------------ 1MIN分钟数据 -----------------------
    Data_Copy(&FLASH_Store_MinData.sensor[0].mindata, &FLASH_Read_MinData.sensor[0].mindata, \
                      &sensors_tempdata->sensor[0].mindata, &Mindata_temp.sensor[0].mindata, num_mins, 0);
    Data_Copy(&FLASH_Store_MinData.sensor[1].mindata, &FLASH_Read_MinData.sensor[1].mindata, \
                      &sensors_tempdata->sensor[1].mindata, &Mindata_temp.sensor[1].mindata, num_mins, 1);
  ...
  //=========================== 相对湿度  ADA ======================================
    strcpy(Header_packet+lenlen,"ADA");
    lenlen=strlen((char *)Header_packet);
    Header_packet[lenlen]=',';
    lenlen++;

    //mindata
    Pack_Data(&Mindata_temp.sensor[0].mindata, &lenlen, Header_packet, 3);
    
    //=========================== 标准差 ADAl ======================================
    strcpy(Header_packet+lenlen,"ADAl");
    lenlen=strlen((char *)Header_packet);
    Header_packet[lenlen]=',';
    lenlen++;
    ...
    //=========================== 露点温度  ADP ======================================
    strcpy(Header_packet+lenlen,"ADP");
    lenlen=strlen((char *)Header_packet);
    Header_packet[lenlen]=',';
    lenlen++;
    ...
    //=========================== 标准差 ADPl ======================================
    strcpy(Header_packet+lenlen,"ADPl");
    lenlen=strlen((char *)Header_packet);
    Header_packet[lenlen]=',';
    lenlen++;
    ...
    if(num_mins == 1)//需要存储分钟数据，来自主动调用
    { //数据保存至flash结构体
      standardDeviation_1 = StandardDeviation(data_sample_buf_history+SAMPLE_COUNT,sample_qc_history[1],SAMPLE_COUNT);
